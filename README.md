## Тиристор
![](https://github.com/Axialer/electronics/blob/main/src/20240618114230.png)
...
### Устройство
![](https://github.com/Axialer/electronics/blob/main/src/20240618120814.jpg)

#### Полевой транзистор
![](https://github.com/Axialer/electronics/blob/main/src/20240618121150.png)
### Схемы включения
![](https://github.com/Axialer/electronics/blob/main/src/20240618150705.png)
![](https://github.com/Axialer/electronics/blob/main/src/20240618154357.png)
...
![](https://github.com/Axialer/electronics/blob/main/src/20240618131233.jpg)
![](https://github.com/Axialer/electronics/blob/main/src/20240618131303.png)
...
Многокаскадные усилители представляют собой конструкцию, в которой несколько усилительных каскадов (ступеней) объединяются последовательно для увеличения общего коэффициента усиления и улучшения других характеристик усиления. Это позволяет создавать устройства с высоким качеством усиления, минимальным уровнем искажений и улучшенной стабильностью.
...
![](https://github.com/Axialer/electronics/blob/main/src/slide-21.jpg)
...
![](https://github.com/Axialer/electronics/blob/main/src/20240618132816.png)
...
#### Схема
![](https://github.com/Axialer/electronics/blob/main/src/20240618133118.png)
...
### Схема
![](https://github.com/Axialer/electronics/blob/main/src/20240618135034.png)
...
### Вах диода
![](https://github.com/Axialer/electronics/blob/main/src/20240618144351.png)
### Виды выпрямителей
...
![](https://github.com/Axialer/electronics/blob/main/src/20240618135935.png)
### Применение
...
## Фотодиоды
Фотодиоды представляют собой полупроводниковые приборы, которые преобразуют световую энергию непосредственно в электрический ток. Они используются для детектирования света в широком спектре приложений, от оптоэлектроники до коммуникационных технологий. 
### Схема
![](https://github.com/Axialer/electronics/blob/main/src/20240618143641.png)
...
Истоковый повторитель (common drain amplifier) представляет собой тип усилителя на полевом транзисторе (FET), который обеспечивает усиление напряжения сигнала между истоком и источником транзистора. Он также известен как усилитель с общим стоком или усилитель с последовательным истоком.
...
Фазочастотные характеристики (часто обозначаемые как ФЧХ) являются важным инструментом для оценки поведения системы или устройства в зависимости от частоты входного сигнала. Они предоставляют информацию о том, как фаза выходного сигнала изменяется в зависимости от частоты входного сигнала.
### Определение
...
## Диоды Шоттки
Диоды Шоттки (Schottky diode) представляют собой особый тип полупроводниковых диодов, обладающих рядом уникальных характеристик, которые делают их полезными в различных электронных приложениях.
### Схема
![](https://github.com/Axialer/electronics/blob/main/src/20240618144715.png)
...
## Варикапы
**Варикапы** (Variable Capacitors) - это полупроводниковый диод, в котором барьерная ёмкость p-n-перехода сильно зависит от величины обратного смещения. С ростом напряжения ёмкость падает.
### Схема
![](https://github.com/Axialer/electronics/blob/main/src/20240618150855.png)
### Устройство и принцип работы
...
Коэффициенты усиления по мощности, току и напряжению являются основными характеристиками усилительных устройств, отражающими их способность увеличивать соответственно мощность, ток или напряжение входного сигнала.
...
![](https://github.com/Axialer/electronics/blob/main/src/20240618155046.png)
